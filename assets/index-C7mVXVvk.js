...
const _sfc_main$1 = {
  ...
  methods: {
    ...
    setRandomNum() {
      this.secretNum = this.getRandomInt(5);
      console.log(this.secretNum);
    },
    warpBack() {
      localStorage.setItem("2022", "1");
      window.location.href = "/fun_stuffs/rocky_2022/index.html";
    }
  }
};
      ...
      default: withCtx(() => [
        createBaseVNode("div", _hoisted_1$1, [
          createBaseVNode("div", _hoisted_2$1, [
            $data.secretNum === 4 ? (openBlock(), createElementBlock("img", {
              key: 0,
              class: "site_logo",
              onClick: _cache[0] || (_cache[0] = ($event) => $options.warpBack()),
              src: _imports_0$1,
              alt: ""
          ...
          _cache[7] || (_cache[7] = createBaseVNode("h4", null, "Special thanks", -1)),
          ...
          _cache[9] || (_cache[9] = createBaseVNode("h4", null, " Special thanks the following artists, without arts created by you this site would be impossible ", -1)),
          _cache[10] || (_cache[10] = createBaseVNode("div", { class: "row row-cols-lg-3 row-cols-md-2 row-cols-1" }, [
          ...
          _cache[11] || (_cache[11] = createBaseVNode("p", null, "...and other artists I missed out, thanks!", -1)),
          _cache[12] || (_cache[12] = createBaseVNode("img", {
            class: "thank_you my-2",
            src: _imports_2,
            alt: ""
          }, null, -1)),
          _cache[13] || (_cache[13] = createBaseVNode("h4", { class: "rocky_thanks" }, '"Thank you for visiting my site!🩷"', -1)),
          _cache[14] || (_cache[14] = createBaseVNode("h4", { class: "rocky_thanks" }, [
  ...
  return openBlock(), createElementBlock("div", _hoisted_1, [
    createBaseVNode("div", _hoisted_2, [
      ...
      createBaseVNode("div", _hoisted_3, [
        ...
        _cache[3] || (_cache[3] = createStaticVNode('<div class="ms-md-5" data-v-00cd7a24><div class="welcome_links" data-v-00cd7a24><div data-v-00cd7a24><div class="w_link" data-v-00cd7a24><h1 data-v-00cd7a24>Welcome to my website!</h1></div></div><a href="/about" data-v-00cd7a24><div class="w_link_logo" data-v-00cd7a24><i class="fas fa-paw" data-v-00cd7a24></i></div><div class="w_link" data-v-00cd7a24><h3 data-v-00cd7a24>About me</h3><h5 data-v-00cd7a24>Everything about me!</h5></div></a><a href="/stories" data-v-00cd7a24><div class="w_link_logo" data-v-00cd7a24><span class="material-symbols-outlined" data-v-00cd7a24> book </span></div><div class="w_link" data-v-00cd7a24><h3 data-v-00cd7a24>Stories</h3><h5 data-v-00cd7a24>My story in Yah-Den Mainland!</h5></div></a><a href="/gallery-list" data-v-00cd7a24><div class="w_link_logo" data-v-00cd7a24><span class="material-symbols-outlined" data-v-00cd7a24> gallery_thumbnail </span></div><div class="w_link" data-v-00cd7a24><h3 data-v-00cd7a24>Gallery</h3><h5 data-v-00cd7a24>My memory in Yah-Den Mainland!</h5></div></a><a href="/fun-stuffs" data-v-00cd7a24><div class="w_link_logo" data-v-00cd7a24><i class="fa-solid fa-snowman" data-v-00cd7a24></i></div><div class="w_link" data-v-00cd7a24><h3 data-v-00cd7a24>Fun stuffs</h3><h5 data-v-00cd7a24>Interesting things I&#39;ve made!</h5></div></a></div></div>', 1))
      ]),
      createVNode(_component_about_popover)
    ])
  ]);
}
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-00cd7a24"]]);
export {
  index as default
};
