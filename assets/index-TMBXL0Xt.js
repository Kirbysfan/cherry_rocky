import { _ as _export_sfc, c as createElementBlock, a as createVNode, w as withCtx, r as resolveComponent, o as openBlock, b as createBaseVNode, d as createTextVNode, g as getDefaultExportFromCjs, e as _imports_2$1, f as createStaticVNode } from "./index-H_KRqZYt.js";
const _imports_2 = "" + new URL("rocky_logo-BrTaHfpz.webp", import.meta.url).href;
const _imports_1 = "" + new URL("rocki_heart_by_nokta-C5bK9ZLi.png", import.meta.url).href;
const _sfc_main$1 = {
  data() {
    return {
      show: false
  ...
  mounted() {
    this.emitter.on("show_credits", (data) => {
      this.show = true;
    });
  }
};
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", null, [
    createVNode(_component_el_dialog, {
      ...
      title: "DNAxCAT Rocky Website Credits"
    }, {
      default: withCtx(() => _cache[1] || (_cache[1] = [
        createBaseVNode("div", { style: { "text-align": "center" } }, [
          ...
          createBaseVNode("h3", null, "DNAxCAT Rocky's personal website"),
          createBaseVNode("h4", null, "Milestone 1.3-safe"),
          createBaseVNode("h4", null, "Created & designed by Kirbysfan, 2022-2026 Kirbysfan"),
          createBaseVNode("h4", null, "Powered by:"),
          createBaseVNode("p", null, [
            createTextVNode(" Vue 3"),
            createBaseVNode("br"),
            createTextVNode(" Vite 6.3.2"),
            createBaseVNode("br"),
            createTextVNode(" Element Plus"),
            createBaseVNode("br"),
            createTextVNode(" JQuery 3.7.1"),
            createBaseVNode("br"),
            createTextVNode(" Bootstrap 5.3.5"),
            createBaseVNode("br"),
            createTextVNode(" Fontawesome 6"),
            createBaseVNode("br"),
            createTextVNode(" Material Symbols"),
            createBaseVNode("br"),
            createTextVNode(" Tencent Cloud"),
            createBaseVNode("br"),
            createTextVNode(" Cloudflare"),
            createBaseVNode("br"),
            createTextVNode(" Seamonkey Composer ")
          ]),
          createBaseVNode("h4", null, "Special thanks"),
          createBaseVNode("p", null, [
            createTextVNode(" Kyuzo"),
            createBaseVNode("br"),
            createTextVNode(" Meimei"),
            createBaseVNode("br"),
            createTextVNode(" Izumikawa"),
            createBaseVNode("br"),
            createTextVNode(" Shuanglin"),
            createBaseVNode("br"),
            createTextVNode(" Hideki"),
            createBaseVNode("br"),
            createTextVNode(" CocoaCaa"),
            createBaseVNode("br"),
            createTextVNode(" Sakura"),
            createBaseVNode("br"),
            createTextVNode(" KnockyPo"),
            createBaseVNode("br"),
            createTextVNode(" maidchankawaii"),
            createBaseVNode("br"),
            createTextVNode(" Micha"),
            createBaseVNode("br"),
            createTextVNode(" ...and you! ")
          ]),
          createBaseVNode("h4", null, " Special thanks the following artists, without arts created by you this site would be impossible "),
          createBaseVNode("div", { class: "row row-cols-lg-3 row-cols-md-2 row-cols-1" }, [
            createBaseVNode("p", null, "saturn_nyan"),
            createBaseVNode("p", null, "糖悠悠"),
            createBaseVNode("p", null, "MeiReiko"),
            createBaseVNode("p", null, "KnockyPo"),
            createBaseVNode("p", null, "meal33"),
            createBaseVNode("p", null, "Hideki"),
            createBaseVNode("p", null, "BreezeCat"),
            createBaseVNode("p", null, "薰凝"),
            createBaseVNode("p", null, "暮璃"),
            createBaseVNode("p", null, "Nokta"),
            createBaseVNode("p", null, "Chiyu"),
            createBaseVNode("p", null, "CookBaron"),
            createBaseVNode("p", null, "うさぎ"),
            createBaseVNode("p", null, "DSLmick"),
            createBaseVNode("p", null, "Sakura"),
            createBaseVNode("p", null, "CocoaCaa"),
            createBaseVNode("p", null, "Izumikawa"),
            createBaseVNode("p", null, "Choushi")
          ]),
          createBaseVNode("p", null, "...and other artists I missed out, thanks!"),
          createBaseVNode("img", {
            class: "thank_you my-2",
            src: _imports_1,
            alt: ""
          }),
          createBaseVNode("h4", { class: "rocky_thanks" }, '"Thank you for visiting my site!🩷"'),
          createBaseVNode("h4", { class: "rocky_thanks" }, [
            createTextVNode(' "You should also check '),
            createBaseVNode("a", { href: "http://dnaxcattalk.dnaxcat.net" }, "DNAxCAT forum!"),
            createTextVNode('" ')
          ])
        ], -1)
      ])),
...
const About_popover = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1], ["__scopeId", "data-v-cc446c08"]]);
...
const bootstrap = /* @__PURE__ */ getDefaultExportFromCjs(bootstrap_bundle_minExports);
const _imports_0 = "" + new URL("rocky_welcome-DI8aGjFO.webp", import.meta.url).href;
const _sfc_main = {
  name: "Index",
  components: { About_popover },
  props: {},
  setup() {
    setTimeout(() => {
  ...
  methods: {
    showCredits() {
      this.emitter.emit("show_credits", true);
    },
    hideLoad() {
      console.log("hide");
...
const _hoisted_4 = { class: "d-flex flex-column align-items-center mt-5 mt-md-0" };
const _hoisted_5 = { class: "welcome_pic_outer" };
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_about_popover = resolveComponent("about_popover");
  return openBlock(), createElementBlock("div", _hoisted_1, [
    createBaseVNode("div", _hoisted_2, [
      _cache[4] || (_cache[4] = createBaseVNode("div", { class: "position-absolute top-0 bg-danger py-2 w-100 m-0" }, [
        createBaseVNode("p", { class: "m-0 p-0 text-truncate text-light ps-2" }, " This is a work in progress project and is not representative to the formal version. ")
      ], -1)),
      createBaseVNode("div", _hoisted_3, [
        createBaseVNode("div", _hoisted_4, [
          createBaseVNode("div", _hoisted_5, [
            createBaseVNode("img", {
              ...
              draggable: "false",
              class: "welcome_pic",
              onMouseup: _cache[0] || (_cache[0] = (...args) => $options.showCredits && $options.showCredits(...args)),
              "data-bs-toggle": "tooltip",
              "data-bs-placement": "top",
              title: "This is Rocky the kawaii cherry meow!🩷",
              "data-bs-html": "true"
            }, null, 32),
            _cache[1] || (_cache[1] = createBaseVNode("div", { class: "bg_star_outer" }, [
              createBaseVNode("img", {
                src: _imports_2$1,
                alt: "",
                class: "bg_star"
        ...
        _cache[3] || (_cache[3] = createStaticVNode('<div class="ms-md-5" data-v-ac70b7d2><div class="welcome_links" data-v-ac70b7d2><div data-v-ac70b7d2><div class="w_link" data-v-ac70b7d2><h1 data-v-ac70b7d2>Welcome to my website!</h1></div></div><a href="/about" data-v-ac70b7d2><div class="w_link_logo" data-v-ac70b7d2><i class="fas fa-paw" data-v-ac70b7d2></i></div><div class="w_link" data-v-ac70b7d2><h3 data-v-ac70b7d2>About me</h3><h5 data-v-ac70b7d2>Everything about me!</h5></div></a><a href="/stories" data-v-ac70b7d2><div class="w_link_logo" data-v-ac70b7d2><span class="material-symbols-outlined" data-v-ac70b7d2> book </span></div><div class="w_link" data-v-ac70b7d2><h3 data-v-ac70b7d2>Stories</h3><h5 data-v-ac70b7d2>My story in Yah-Den Mainland!</h5></div></a><a href="/gallery-list" data-v-ac70b7d2><div class="w_link_logo" data-v-ac70b7d2><span class="material-symbols-outlined" data-v-ac70b7d2> gallery_thumbnail </span></div><div class="w_link" data-v-ac70b7d2><h3 data-v-ac70b7d2>Gallery</h3><h5 data-v-ac70b7d2>My memory in Yah-Den Mainland!</h5></div></a><a href="/fun-stuffs" data-v-ac70b7d2><div class="w_link_logo" data-v-ac70b7d2><i class="fa-solid fa-snowman" data-v-ac70b7d2></i></div><div class="w_link" data-v-ac70b7d2><h3 data-v-ac70b7d2>Fun stuffs</h3><h5 data-v-ac70b7d2>Interesting things I&#39;ve made!</h5></div></a></div></div>', 1))
      ]),
      createVNode(_component_about_popover)
    ])
  ]);
}
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-ac70b7d2"]]);
export {
  index as default
};
