...
const _hoisted_5 = { class: "formal_sona_sect mt-2" };
const _hoisted_6 = { class: "gallery-switch" };
const _hoisted_7 = { class: "gallery row row-cols-xxl-4 row-cols-lg-3 row-cols-sm-2" };
const _hoisted_8 = ["onClick"];
const _hoisted_9 = ["title"];
const _hoisted_10 = { class: "col-12 mb-2 p-0 thumb-outer" };
const _hoisted_11 = ["src"];
const _hoisted_12 = { class: "col-10" };
const _hoisted_13 = ["innerHTML"];
const _hoisted_14 = ["innerHTML"];
const _hoisted_15 = { class: "d-md-flex justify-content-between small flex-nowrap overflow-hidden" };
const _hoisted_16 = { class: "text-truncate text-nowrap overflow-hidden" };
const _hoisted_17 = { class: "flex-shrink-0 overflow-hidden" };
const _hoisted_18 = { class: "d-flex justify-content-center pagination mt-4" };
...
${item.sub}`
                  ...
                  createBaseVNode("div", _hoisted_12, [
                    ...
                    createBaseVNode("div", _hoisted_15, [
                      ...
                      createBaseVNode("div", _hoisted_17, toDisplayString(item.date), 1)
                    ])
                  ])
                ], 10, _hoisted_9)
              ], 8, _hoisted_8);
