import { _ as _export_sfc, c as createElementBlock, f as createStaticVNode, b as createBaseVNode, F as Fragment, h as renderList, o as openBlock, e as _imports_2, j as withDirectives, v as vShow, t as toDisplayString } from "./index-T27XikEi.js";
...
const _sfc_main = {
  ...
  computed: {},
  mounted() {
    this.is2022 = localStorage.getItem("2022");
    this.hideLoad();
  },
  methods: {
    copyToCipboard(info) {
...
const _hoisted_15 = { class: "m-0 text-nowrap text-truncate mb-1" };
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1, [
    _cache[5] || (_cache[5] = createStaticVNode('<div class="banner" data-v-ac068cca><img class="d-none d-md-block position-relative banner_stub" src="' + _imports_0 + '" alt="" data-v-ac068cca><img class="d-block d-md-none position-relative banner_stub_mobile" src="' + _imports_1 + '" alt="" data-v-ac068cca><div class="banner_text" data-v-ac068cca><div data-v-ac068cca><div class="banner_h1" data-v-ac068cca><img class="banner_hoshi" src="' + _imports_2 + '" alt="" draggable="false" data-v-ac068cca><h1 class="mx-2" data-v-ac068cca>Fun stuffs</h1><img class="banner_hoshi" src="' + _imports_2 + '" alt="" draggable="false" data-v-ac068cca></div><p data-v-ac068cca>Interesting things I&#39;ve made!</p></div></div></div>', 1)),
            ...
            createBaseVNode("div", _hoisted_6, [
              (openBlock(true), createElementBlock(Fragment, null, renderList($data.list, (item, index) => {
                return withDirectives((openBlock(), createElementBlock("a", {
                  ...
                  [vShow, !item.is2022 || item.is2022 === $data.is2022]
                ]);
              }), 128))
            ])
          ]),
            ...
            createBaseVNode("div", _hoisted_13, [
              (openBlock(true), createElementBlock(Fragment, null, renderList($data.downloadables, (item, index) => {
                return openBlock(), createElementBlock("div", {
                  ...
                  _cache[1] || (_cache[1] = createBaseVNode("div", { class: "col-2 flex-shrink-0 d-flex justify-content-center" }, [
                    createBaseVNode("img", {
                      src: _imports_2,
                      alt: "",
                      draggable: "false",
...
const funStuffs = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-ac068cca"]]);
export {
