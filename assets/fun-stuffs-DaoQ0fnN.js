...
import { _ as _export_sfc, c as createElementBlock, f as createStaticVNode, b as createBaseVNode, F as Fragment, h as renderList, o as openBlock, e as _imports_2, t as toDisplayString } from "./index-CLxC4qpo.js";
const _sfc_main = {
  name: "Stories",
  props: {},
  data() {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1, [
    _cache[5] || (_cache[5] = createStaticVNode('<div class="banner" data-v-cb0728f9><img class="d-none d-md-block position-relative banner_stub" src="' + _imports_0 + '" alt="" data-v-cb0728f9><img class="d-block d-md-none position-relative banner_stub_mobile" src="' + _imports_1 + '" alt="" data-v-cb0728f9><div class="banner_text" data-v-cb0728f9><div data-v-cb0728f9><div class="banner_h1" data-v-cb0728f9><img class="banner_hoshi" src="' + _imports_2 + '" alt="" draggable="false" data-v-cb0728f9><h1 class="mx-2" data-v-cb0728f9>Fun stuffs</h1><img class="banner_hoshi" src="' + _imports_2 + '" alt="" draggable="false" data-v-cb0728f9></div><p data-v-cb0728f9>Interesting things I&#39;ve made!</p></div></div></div>', 1)),
...
const funStuffs = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-cb0728f9"]]);
export {
